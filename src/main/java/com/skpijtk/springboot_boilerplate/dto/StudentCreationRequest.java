// File: src/main/java/com/proyekmu/attendanceapp/dto/StudentCreationRequest.java
...
public class StudentCreationRequest {
    ...
    @Size(min = 6, max = 12, message = "Password harus antara 6 dan 12 karakter")
    @Pattern(regexp = "^(?=.*[A-Za-z])(?=.*\\d)[A-Za-z\\d]{6,12}$", message = "Password harus kombinasi huruf dan angka, tanpa spesial karakter atau spasi")
